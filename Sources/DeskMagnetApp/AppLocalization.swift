...
struct AppStrings: Equatable {
    ...
    private static let valuesByLanguage: [AppLanguage: AppStrings] = [
        .english: AppStrings(
            ...
            restoringTitle: "Putting your desktop back the way it was",
        ...
        .japanese: AppStrings(
            ...
            attachedTitleSingularFormat: nil,
            restoringTitle: "デスクトップを元の状態に戻しています",
        ...
        .spanish: AppStrings(
            ...
            restoringTitle: "Devolviendo el escritorio a su estado anterior",
        ...
        .french: AppStrings(
            ...
            restoringTitle: "Remise du bureau dans son état précédent",
        ...
        .portuguese: AppStrings(
            ...
            restoringTitle: "Restaurando o Desktop ao estado anterior",
        ...
        .korean: AppStrings(
            ...
            attachedTitleSingularFormat: nil,
            restoringTitle: "데스크톱을 원래대로 되돌리는 중",
            failedTitle: "정리 실패",
        ...
        .german: AppStrings(
            ...
            restoringTitle: "Desktop wird in den vorherigen Zustand versetzt",
        ...
        .hindi: AppStrings(
            ...
            restoringTitle: "डेस्कटॉप पहले जैसा किया जा रहा है",
