...
成员清单
AppDelegate.swift: AppKit 生命周期，创建固定 800x520 full-size 亮色主窗口、让系统三按钮落入绿色顶栏、转换 Finder 顶左坐标、关闭时自动恢复、启动未恢复状态检测
ContentView.swift: SwiftUI 内容区，以单一绿色主色、1:3 顶栏/主体分区呈现“桌面清理大师”工具面板，不暴露吸附实现
