...
AppLocalization.swift: 本地化单一真相源，维护系统语言默认值、用户语言选择、中繁英日韩五套软件名/窗口/菜单文案与完成态单复数
...
DeskMagnetViewModel.swift: 主窗口状态模型，调用 AppCoordinator 执行吸附、关闭恢复、跟随同步、焦点恢复、损坏状态显形并按当前语言呈现错误
