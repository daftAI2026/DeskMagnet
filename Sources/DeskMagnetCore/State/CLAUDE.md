...
Models.swift: 领域数据模型，定义 Point、ScreenFrame、DesktopItem、带 path 身份的 IconMove、RecoveryStateStatus、RecoveryState、IconPerformancePolicy、IconPerformanceNotice、DeskMagnetError
